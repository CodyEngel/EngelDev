...
class NetworkRequests(
	...
	suspend fun getRecentVideos(apiKey: YouTubeApiKey, limit: Int): YouTubeSearchResult {
		...
		return tracer.spanBuilder("GetRecentVideos").startScopedSpan().use {
	...
	suspend fun postMailchimpMember(
		apiKey: MailchimpApiKey,
		mailchimpRequest: MailchimpMemberRequest,
	): Pair<MailchimpMemberResponse?, MailchimpError?> {
